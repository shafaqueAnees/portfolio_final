      ...
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full p-8 flex-col">
          ...
          <div className="flex-grow">
           <div className='relative h-1 w-full bg-blue-300 rounded-xl'>
      ...
      <div className="p-4 w-[100%]  md:w-1/3">
        <div className="flex rounded-lg h-full p-8 flex-col">
          <div className="flex items-center mb-3">
            ...
            <h2 className="text-gray-900 text-lg title-font font-medium">JS</h2>
          </div>
          <div className="flex-grow">
           <div className='relative h-1 w-full bg-blue-300 rounded-xl'>
      ...
      <div className="p-4 w-[100%]  md:w-1/3">
        <div className="flex rounded-lg h-full p-8 flex-col">
          <div className="flex items-center mb-3">
            ...
            <h2 className="text-gray-900 text-lg title-font font-medium">Graphic Desinging</h2>
          </div>
          <div className="flex-grow">
           <div className='relative h-1 w-full bg-blue-300 rounded-xl'>
            <div className='absolute bg-blue-500 h-1 rounded-xl w-[50%]'></div>
